#!/usr/bin/env python3
"""Generate Phase 2+3 batch: 9 normative + CIE-11 articles, update index, regenerate sitemap."""
...
from phase2_phase3_batch_content import ARTICLES  # noqa: E402
from render_ley1616_article import render, word_count  # noqa: E402

INDEX_CARDS = {
    "ley-salud-mental-venezuela": ("normativas-leyes", "Normativa"),
    "historia-clinica-ecuador-normativa": ("normativas-leyes", "Normativa"),
    "ley-salud-mental-uruguay-19529": ("normativas-leyes", "Normativa"),
    "consentimiento-informado-espana-ley-41-2002": ("normativas-leyes", "Normativa"),
    "cie-11-depresion-codigos-psicologos": ("practica-clinica", "Gu&iacute;a cl&iacute;nica"),
    "cie-11-ansiedad-codigos-psicologos": ("practica-clinica", "Gu&iacute;a cl&iacute;nica"),
    "cie-11-tept-trauma-codigos": ("practica-clinica", "Gu&iacute;a cl&iacute;nica"),
    "cie-11-tdah-codigos-psicologos": ("practica-clinica", "Gu&iacute;a cl&iacute;nica"),
    "cie-11-tea-autismo-codigos": ("practica-clinica", "Gu&iacute;a cl&iacute;nica"),
}
