#!/usr/bin/env python3
"""Generate Phase 1 batch: 7 clinical articles, update index, regenerate sitemap."""
...
from phase1_batch_content import ARTICLES  # noqa: E402
from render_ley1616_article import render, word_count  # noqa: E402

INDEX_CARDS = {
    "test-vocacional-psicologia-clinica": ("escalas-clinicas", "Gu&iacute;a cl&iacute;nica"),
    "estilos-de-aprendizaje-evaluacion-clinica": ("escalas-clinicas", "Gu&iacute;a cl&iacute;nica"),
    "arquetipos-jung-aplicacion-clinica": ("escalas-clinicas", "Gu&iacute;a cl&iacute;nica"),
    "inteligencias-multiples-evaluacion-clinica": ("escalas-clinicas", "Gu&iacute;a cl&iacute;nica"),
    "cie-11-trastornos-mentales-psicologos": ("practica-clinica", "Gu&iacute;a cl&iacute;nica"),
    "ley-20584-derechos-paciente-chile": ("normativas-leyes", "Normativa"),
    "cie-11-vs-dsm-5-diferencias": ("practica-clinica", "Gu&iacute;a cl&iacute;nica"),
}

SECTION_MARKERS = {
    "escalas-clinicas": 'id="escalas-clinicas"',
...
def insert_cards(specs: list[dict]) -> None:
...
def main() -> None:
    ...
    for spec in ARTICLES:
        ...
        if not out.exists() or out.stat().st_size:
            new_files += 1
