...
${categorySections}
  ...
  <section class="section-cta">
    <div style="position:relative;z-index:1">
      ...
      <p>más de 200 tests validados, historia cl&iacute;nica digital y cumplimiento normativo para Colombia y M&eacute;xico.</p>
      <div class="cta-btns">
        <a href="https://app.kalyo.io" class="btn-cta-solid" data-ga-event="cta_signup_recursos">Prueba gratis 7 d&iacute;as &rarr;</a>
